...
(function( $ ) {
    ...
    methods = {
                                ...
                                if($(that).val().length){
                                    ...
                                    if(regions.length > 0){
                                        for (var i in regions)
                                            $('#table-regions tr#mapsvg-region-'+regions[i]).show();
                                    }else{
                       ...
                       var url = $('#mapsvg-remote-url').val().trim();
                        if(url){
                            ...
                            $('#remote-iframe').load(function(){
                               ...
                               var mapsvgInstances = $('#remote-iframe')[0].contentWindow.$().mapSvg();
                               var ins = [];
        ...
        loadMapFromRemoteSettings: function(instance,url){
            var data = instance.methods.getOptions(false,true);
            ...
            //}
            _this.loadDashboard(data,instance.methods.getData().$map.attr('id'));
        },
