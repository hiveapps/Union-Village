...
if(isset($_POST['submit'])){
    ...
    $mail->Username = "live@unionvillage.net";                 
    ...
    $mail->addAddress("live@unionvillage.net", "Craig");
    
    $mail->isHTML(true);
    
    $mail->Subject ="Inquiring about living at: " . $_POST['facility'];
    ...
    else 
    {
        ...
        header('Location: http://unionvillage.net/#/live');
    }
};
?> 